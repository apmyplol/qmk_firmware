 ...
 */
[_LOWER] = LAYOUT(
  KC_DEL , KC_PSCR,   KC_F3,   KC_F4,  KC_F5,   KC_F6,                     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_EQL,
  XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,  XXXXXXX,                     _______, _______, _______,_______, _______, KC_RBRC,  
  KC_GRV, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_NUHS,
  _______, _______, _______, _______, _______, _______,KC_MUTE, _______, XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
...
[_RAISE] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                        KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_RCBR,
